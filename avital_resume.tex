...
% personal data
\name{Pierre}{Avital}
% \title{Chercheur en Traitement de Signal}                               % optional, remove / comment the line if not wanted
...
%            content
%----------------------------------------------------------------------------------
\geometry{bottom=1.5cm,top=2.5cm}
\begin{document}
...
\begin{itemize}
    ...
    \item{\cventry{Juin 2018 -- Aujourd'hui}{Doctorat en Traitement du Signal}{CentraleSupélec (L2S) - Valeo}{Gif-sur-Yvette - Créteil}{}{\vspace{3pt}
    Dans le cadre du projet où j'étais ingénieur à mon poste précédent, je réalise actuellement une thèse en partenariat avec le L2S de CentraleSupélec.\\
    \underline{Intitulé:} Nouvelles stratégies de localisation dans un environnement de propagation complexe.\\
    \underline{Encadrants:} José Picheral, Gilles Chardon
    }}
    
    \vspace{6pt}

    \item{\cventry{Novembre 2017 -- Juin 2018}{Ingénieur recherche et développement}{Valeo}{Créteil}{}{\vspace{3pt}Dans le cadre d'un projet d'ouverture passive de véhicule, j'ai travaillé sur la localisation non-coopérative à courte portée d'un smartphone en environement de propagation complexe. Les contraintes principales du projet étant l'universalité et la consommation électrique, Bluetooth LE avait été choisi comme technologie de support.\\Mon rôle se divisait en deux composantes: d'un coté, l'étude des méthodes de localisation en elles-même, à travers des algorithmes tels que MUSIC et ESPRIT ; de l'autre, le développement d'une grande part des logiciels utiliséss dans le cadre du projet, notamment pour assurer la communication entre les divers composants. }}
